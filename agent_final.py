...
def log_session_entry(question: str, task: dict, result: dict) -> None:
    SESSION_HISTORY.append({'timestamp': datetime.utcnow().isoformat() + 'Z', 'question': question, 'task': task, 'result': result})
